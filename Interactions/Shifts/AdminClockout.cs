...
{
    public class AdminClockout : InteractionData
    {
        ...
        public override async Task ExecuteAsync(InteractionContext ctx)
        {
            ...
            var (shift, errormessage) = await Procedures.Clockout(long.Parse(ctx.GuildId), long.Parse(userId), type, long.Parse(adminId));
